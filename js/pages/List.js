...
function getLevelThumbnail(level) {
    // 1. MANUAL OVERRIDE: Check if you defined a custom thumbnail in the JSON
    if (level.thumbnail) {
        return level.thumbnail; // Uses your manual image link
    }
    
    // 2. DEFAULT: Extract YouTube ID from the video link
    let url = level.video || "";
    let videoId = '';
    ...
    if (videoId) {
        // '2.jpg' is automatically generated by YouTube from the middle of the video
